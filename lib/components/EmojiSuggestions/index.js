...
var _distEs = require('emoji-mart/dist-es');
  ...
  function EmojiSuggestions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EmojiSuggestions.__proto__ || Object.getPrototypeOf(EmojiSuggestions)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.popover) {
        ...
        var size = _this.filteredEmojis.length;
      ...
      _this.onEmojiFocus(newIndex >= _this.filteredEmojis.length ? 0 : newIndex);
    }, _this.onTab = function (keyboardEvent) {
      keyboardEvent.preventDefault();
      _this.commitSelection();
    }, _this.onUpArrow = function (keyboardEvent) {
      keyboardEvent.preventDefault();
      if (_this.filteredEmojis.length > 0) {
        var newIndex = _this.state.focusedOptionIndex - 1;
      ...
      _this.closeDropdown();
      var newEditorState = (0, _addEmoji2.default)(_this.props.store.getEditorState(), emoji.native, _addEmoji.Mode.REPLACE);
      ...
      var emojiIndex = new _distEs.NimbleEmojiIndex(_emojione2.default, _this.props.emojiSet);

      if (emojiValue.length === 0) {
        return [emojiIndex.search('+1')[0], emojiIndex.search('-1')[0], emojiIndex.search('white_check_mark')[0], emojiIndex.search('100')[0]];
      }
      ...
      _this.onEmojiSelect(_this.filteredEmojis[_this.state.focusedOptionIndex]);
      return 'handled';
  ...
  _createClass(EmojiSuggestions, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          restProps = _objectWithoutProperties(_props, ['theme', 'ariaProps', 'callbacks', 'onClose', 'onOpen', 'onSearchChange', 'positionSuggestions', 'store', 'useNativeArt', 'emojiSet']);
